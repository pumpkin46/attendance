...
async def register(body: RegisterRequest, request: Request, db: DbSession):
    ...
    # admins grant access later through user management. Users no longer carry
    # an organization — their tenant is resolved from the single active company
    # at request time (see get_tenant_org_id).
